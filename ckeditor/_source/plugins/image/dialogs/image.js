						...
						},
						{
							...
							'for' : [ 'Upload', 'upload' ]
                                                ...
                                                */
                                                {
                                                        type : 'html',
                                                        html : '<p>Use the "Browse Server" button to locate the <br />'
                                                               + 'directory on the server where you want to put <br />'
                                                               + 'an image file, then click "Upload" to find an <br />'
                                                               + 'image file on your computer</p>'
                                                },
                                                {
                                                        type : 'button',
                                                        id : 'browse',
